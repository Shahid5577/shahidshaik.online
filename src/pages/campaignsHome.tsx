...
import CampaignsHomeFeature, {campaignFeatures} from "../components/features/campaignFeatures";
interface CampaignHomeProps {}

const CampaignsHome: React.FC<CampaignHomeProps> = ({}) => {
  useEffect(() => {
    updateTitleAndFavicon("Clikkle Campaigns | #1 Email marketing and Automation Software", "https://cdn.clikkle.com/images/campaigns/logo/2023/campaigns.png");
  }, []);
    ...
    <div  className="px-2 py-8 sm:px-6 sm:py-6">
      <div id='home-section' className="p-4 flex flex-col sm:flex-row mt-0 sm:items-center justify-center sm:justify-start h-[calc(68vh-65px)] ml-2 gap-10">
        <div className="max-w-[600px] px-4 sm:px-8 pb-12 sm:mr-10 gap-6 text-center text-sm">
          <Typography
            variant="h3"
            className="hidden mt-4 font-light text-center text-gray-800 sm:flex sm:text-left dark:text-gray-300 pr-48"
          >
            Automation for Marketing Teams
          </Typography>
          ...
          >
            Expand your marketing with a complete set of tools,
            including web, social, email, chat, and text. Connect at
            every stage of the customer lifecycle for engagement
            beyond email.
          </Typography>
          <Typography
            className="font-normal text-center text-gray-800 sm:hidden sm:text-left dark:text-gray-300 sm:mt-0"
          ...
          <img
            src="https://cdn.clikkle.com/images/campaigns/illustration/campaigns1.png"
      ...
      <div className="flex flex-col items-center justify-center gap-5 sm:mt-7">
        {campaignFeatures.map((campaignFeatures, index) => (
            <CampaignsHomeFeature
             {...{ campaignFeatures, left: index % 2 === 0, key: campaignFeatures.name }}
          />
        ))}
      </div>
      ...
      <div id="overview" className="h-[calc(100vh-100px)] flex flex-col items-center justify-center gap-8 mt-10 pt-10">
        <Typography
          ...
          className="text-2xl text-center text-gray-800 sm:text-left dark:text-gray-300"
        >
          Advanced Business Tools: Leverage for Success
        </Typography>

        <br />

        <img
          src="https://cdn.clikkle.com/images/campaigns/logo/2023/campaigns.png"
        ...
        Clikkle Campaigns offers smart content tools to improve writing and
        prevent spam, along with powerful AI features for secure business
        promotion. Perfect for businesses of all sizes.
          </Typography>
          ...
          >
            Learn more about Clikkle Campaigns
          </Link>
        </div>
      </div>
        ...
        <div className="flex flex-col items-center justify-center flex-grow gap-8">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <Button variant="outlined" size="small">
              <Link to="https://clikkle.com/gotoplus">Go to Campaigns</Link>
            </Button>
          </div>
        </div>
