...
import PitchHomeFeature, {pitchFeatures} from "../components/features/pitchFeatures";

interface PitchHomeProps {}

const PitchHome: React.FC<PitchHomeProps> = ({}) => {
  useEffect(() => {
    updateTitleAndFavicon("Clikkle Pitch | Presentation Software For Fast Moving Teams", "https://cdn.clikkle.com/images/pitch/logo/2023/pitch.png");
  }, []);
    ...
    <div  className="px-2 py-8 sm:px-6 sm:py-6">
      <div id='home-section' className="p-4 flex flex-col sm:flex-row mt-0 sm:items-center justify-center sm:justify-start h-[calc(68vh-65px)] ml-2 gap-10">
        <div className="max-w-[600px] px-4 sm:px-8 pb-12 sm:mr-10 gap-6 text-center text-sm">
          ...
          >
            Embrace the Symphony of Pitches
          </Typography>
          ...
          >
            Expand your marketing with a complete set of tools, including web, social, email, chat, and text. Connect at every stage of the customer lifecycle for engagement beyond email.
        </Typography>
          <Typography
        ...
        <div className="items-center justify-center hidden ml-16 sm:flex ">
          <img
            src="https://cdn.clikkle.com/images/pitch/illustration/pitch1.png"
      ...
      <div className="flex flex-col items-center justify-center gap-5 sm:mt-7">
        {pitchFeatures.map((pitchFeatures, index) => (
            <PitchHomeFeature
             {...{ pitchFeatures, left: index % 2 === 0, key: pitchFeatures.name }}
          />
        ))}
      </div>
      ...
      <div id="overview" className="h-[calc(100vh-100px)] flex flex-col items-center justify-center gap-8 mt-10 pt-10">
        <Typography
          ...
          className="text-2xl text-center text-gray-800 sm:text-left dark:text-gray-300"
        >
            Pitch perfection for lasting impressions.
        </Typography>

        <br />

        <img
          src="https://cdn.clikkle.com/images/pitch/logo/2023/pitch.png"
        ...
        <div className="max-w-[600px] flex flex-col items-center justify-center">
          <Typography className="text-center">
           Clikkle elevates your pitch with storytelling, strategic brilliance, visual symphonies, dynamic delivery, and flawless execution. Trust us to bring your ideas to life and leave an impression.
          </Typography>
          ...
          <div className="flex items-center justify-center gap-4">
            <Button variant="contained" size="small">
              <Link to="https://clikkle.com/tryclikkleplus">
                Try Clikkle Pitch for Free
              </Link>
            </Button>
            <Button variant="outlined" size="small">
              <Link to="https://clikkle.com/gotoplus">Go to Clikkle Pitch</Link>
            </Button>
          </div>
        </div>
