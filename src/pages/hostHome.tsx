...
import HostHomeFeature, {hostFeatures} from "../components/features/hostFeatures";

interface HostHomeProps {}

const HostHome: React.FC<HostHomeProps> = ({}) => {
  useEffect(() => {
    updateTitleAndFavicon("Clikkle Host | Web Hosting With 24/7 Support, Ai Tools And Free Domain", "https://cdn.clikkle.com/images/host/logo/2023/host.png");
  }, []);
    ...
    <div  className="px-2 py-8 sm:px-6 sm:py-6">
      <div id='home-section' className="p-4 flex flex-col sm:flex-row mt-0 sm:items-center justify-center sm:justify-start h-[calc(68vh-65px)] ml-2 gap-10">
        <div className="max-w-[600px] px-4 sm:px-8 pb-12 sm:mr-10 gap-6 text-center text-sm">
          ...
          >
            Experience High-Performance Hosting
          </Typography>
          ...
          >
            Our state-of-the-art hosting infrastructure offers advanced security, robust scalability, and expert support for optimal website performance and reliable uptime, Join now.
          </Typography>
          <Typography
        ...
        <div className="items-center justify-center hidden  ml-16 sm:flex ">
          <img
            src="https://cdn.clikkle.com/images/host/illustration/host1.png"
      ...
      <div className="flex flex-col items-center justify-center gap-5 sm:mt-7">
        {hostFeatures.map((hostFeatures, index) => (
            <HostHomeFeature
             {...{ hostFeatures, left: index % 2 === 0, key: hostFeatures.name }}
          />
        ))}
      </div>
      ...
      <div id="overview" className="h-[calc(100vh-100px)] flex flex-col items-center justify-center gap-8 mt-10 pt-10">
        <Typography
          ...
          className="text-2xl text-center text-gray-800 sm:text-left dark:text-gray-300"
        >
        Scalable Hosting Solutions for Growing Websites.
        </Typography>

        <br />

        <img
          src="https://cdn.clikkle.com/images/host/logo/2023/host.png"
          ...
          <div className="flex items-center justify-center gap-4">
            <Button variant="contained" size="small">
              <Link to="https://clikkle.com/tryclikkleplus">
                Try Clikkle Host for Free
              </Link>
            </Button>
            <Button variant="outlined" size="small">
              <Link to="https://clikkle.com/gotoplus">Go to Clikkle Host</Link>
            </Button>
          </div>
        </div>
