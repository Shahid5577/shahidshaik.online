...
import KeptUpHomeFeature, {keptupFeatures} from "../components/features/keptupFeatures";
import kept from './images/kept.png';
import work from './images/icon.png';
import play from './images/playstore.png';
import store from './images/play.png';



interface KeptUpHomeProps {}

const KeptUpHome: React.FC<KeptUpHomeProps> = ({}) => {

  useEffect(() => {
    updateTitleAndFavicon("Clikkle KeptUp | .......", "https://cdn.clikkle.com/images/kept-up/logo/2023/kept-up.png");
  }, []);
    ...
    <div  className="px-2 py-8 sm:px-6 sm:py-6">
      <div id='home-section' className="p-4 flex flex-col sm:flex-row mt-0 sm:items-center justify-center sm:justify-start h-[calc(68vh-65px)] ml-2 gap-10">
        <div className="max-w-[600px] px-4 sm:px-8 pb-12 sm:mr-10 gap-6 text-center text-sm">
          ...
          >
           Simplify home maintenance like never before
           with KeptUp-your comprehensive solution for
         ...
         <div className="flex flex-col items-center mt-6 sm:flex-row sm:justify-start sm:gap-0">
            <img src={play} /> <img src={store}/>
          </div>
          <div className="flex flex-col items-center  mt-2 sm:flex-row sm:gap-2">
            ...
            >
              ...
              <img src={work}/> <p className="sm:text-sm lg:text-lg">How it Works</p>
          </div>
        </div>
      ...
      <div className="flex flex-col items-center justify-center gap-5 sm:mt-7">
        {keptupFeatures.map((keptupFeatures, index) => (
            <KeptUpHomeFeature
             {...{ keptupFeatures, left: index % 2 === 0, key: keptupFeatures.name }}
          />
        ))}
      </div>
      ...
      <div id="overview" className="h-[calc(100vh-100px)] flex flex-col items-center justify-center gap-8 mt-10 pt-10">
        ...
        <div className="max-w-[600px] flex flex-col items-center justify-center">
          <Typography className="text-center">
            Maximize your ad ROI with Clikkle's AI-powered platform. Real-time
            programmatic buying, dynamic retargeting, and hyper-targeted
            geofencing. Join now for data-driven success.
          </Typography>
        ...
        <div className="flex flex-col items-center justify-center flex-grow gap-8">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <Button variant="outlined" size="small">
              <Link to="https://clikkle.com/gotoplus">Go to Clikkle Ads</Link>
            </Button>
          </div>
        </div>
