...
import FilesHomeFeature, {filesFeatures} from "../components/features/filesFeatures";

interface FilesHomeProps {}

const FilesHome: React.FC<FilesHomeProps> = ({}) => {
  useEffect(() => {
    updateTitleAndFavicon("Clikkle Files | Secure File Sharing Backup And Recovery", "https://cdn.clikkle.com/images/files/logo/2023/files.png");
  }, []);
    ...
    <div  className="px-2 py-8 sm:px-6 sm:py-6">
      <div id='home-section' className="p-4 flex flex-col sm:flex-row mt-0 sm:items-center justify-center sm:justify-start h-[calc(68vh-65px)] ml-2">
        <div className="max-w-[600px] px-4 sm:px-8 pb-12 sm:mr-10 gap-6 text-center text-sm">
          ...
          >
            Clikkle: Secure cloud file storage made easy. Effortless file
            management, flexible sharing, and multi-device access
            with advanced encryption and authentication, Join now.
            </Typography>
          <Typography
            className="font-normal text-center text-gray-800 sm:hidden sm:text-left dark:text-gray-300 sm:mt-0"
        ...
        <div className="items-center justify-center hidden ml-16 sm:flex ">
          <img
            src="https://cdn.clikkle.com/images/files/illustration/files1.png"
      ...
      <div className="flex flex-col items-center justify-center gap-5 sm:mt-7">
        {filesFeatures.map((filesFeatures, index) => (
            <FilesHomeFeature
             {...{ filesFeatures, left: index % 2 === 0, key: filesFeatures.name }}
          />
        ))}
      </div>
      ...
      <div id="overview" className="h-[calc(100vh-100px)] flex flex-col items-center justify-center gap-8 mt-10 pt-10">
        <Typography
          ...
          className="text-2xl text-center text-gray-800 sm:text-left dark:text-gray-300"
        >
        Revolutionize Your File Storage Experience Today!
        </Typography>

        <br />

        <img
          src="https://cdn.clikkle.com/images/files/logo/2023/files.png"
        ...
        <div className="max-w-[600px] flex flex-col items-center justify-center">
          ...
          >
            Learn more about Clikkle Files
          </Link>
        </div>
      </div>
          ...
          <div className="flex items-center justify-center gap-4">
            <Button variant="contained" size="small">
              <Link to="https://clikkle.com/tryclikkleplus">
                Try Clikkle Files for Free
              </Link>
            </Button>
            <Button variant="outlined" size="small">
              <Link to="https://clikkle.com/gotoplus">Go to Clikkle Files</Link>
            </Button>
          </div>
        </div>
