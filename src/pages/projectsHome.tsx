...
import ProjectsHomeFeature, {projectsFeatures} from "../components/features/projectsFeatures";

interface ProjectsHomeProps {}

const ProjectsHome: React.FC<ProjectsHomeProps> = ({}) => {
  useEffect(() => {
    updateTitleAndFavicon("Clikkle Projects | #1 Issue And Project Tracking Software", "https://cdn.clikkle.com/images/projects/logo/2023/projects.png");
  }, []);
    ...
    <div  className="px-2 py-8 sm:px-6 sm:py-6">
      <div id='home-section' className="p-4 flex flex-col sm:flex-row mt-0 sm:items-center justify-center sm:justify-start h-[calc(68vh-65px)] ml-2 gap-10">
        <div className="max-w-[600px] px-4 sm:px-8 pb-12 sm:mr-10 gap-6 text-center text-sm">
          ...
          >
           Management of Projects with Smart AI
          </Typography>
          ...
          >
            Efficiently Optimize Workflows and Enhance Collaborative Team Performance through the Cutting-Edge Capabilities of AI-Powered Project Management Tools
           </Typography>
          <Typography
        ...
        <div className="items-center justify-center hidden  ml-16 sm:flex ">
          <img
            src="https://cdn.clikkle.com/images/projects/illustration/projects1.png"
      ...
      <div className="flex flex-col items-center justify-center gap-5 sm:mt-7">
        {projectsFeatures.map((projectsFeatures, index) => (
            <ProjectsHomeFeature
             {...{ projectsFeatures, left: index % 2 === 0, key: projectsFeatures.name }}
          />
        ))}
      </div>
      ...
      <div id="overview" className="h-[calc(100vh-100px)] flex flex-col items-center justify-center gap-8 mt-10 pt-10">
        <Typography
          ...
          className="text-2xl text-center text-gray-800 sm:text-left dark:text-gray-300"
        >
        Driving Success with Innovative Project Management
        </Typography>

        <br />

        <img
          src="https://cdn.clikkle.com/images/projects/logo/2023/projects.png"
        ...
        Discover our innovative project management solutions, powered by cutting-edge technology. Streamline workflows, foster collaboration and achieve enhanced success in your projects effortlessly.
          </Typography>
        ...
        <div className="flex flex-col items-center justify-center flex-grow gap-8">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <Button variant="outlined" size="small">
              <Link to="https://clikkle.com/gotoplus">Go to Projects</Link>
            </Button>
          </div>
        </div>
