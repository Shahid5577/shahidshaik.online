...
import SmsHomeFeature, {smsFeatures} from "../components/features/smsFeatures";
import SmsHomeFeatures from "../components/features/SmsFeature";

interface SmsHomeProps {}

const SmsHome: React.FC<SmsHomeProps> = ({}) => {
  useEffect(() => {
    updateTitleAndFavicon("Clikkle Watsup | Secure Reliable Free Private Messaging And Calling", "https://cdn.clikkle.com/images/sms/logo/2023/sms.png");
  }, []);
    ...
    <div  className="px-2 py-8 sm:px-6 sm:py-6">
      <div id='home-section' className="p-4 flex flex-col sm:flex-row mt-0 sm:items-center justify-center sm:justify-start h-[calc(68vh-65px)] ml-2 gap-10">
        <div className="max-w-[600px] px-4 sm:px-8 pb-12 sm:mr-10 gap-6 text-center text-sm">
          <Typography
            variant="h3"
            className="hidden mt-4 font-light text-center text-gray-800 sm:flex sm:text-left dark:text-gray-300 pr-52"
          >
            Less to stress, more to love
          </Typography>

          <Typography
            variant="h5"
            className="font-normal text-center text-gray-800 sm:hidden sm:text-left dark:text-gray-300 sm:mt-0 pr-12"
            >
              Less to stress, more to love
          </Typography>
          ...
          >
            Connect seamlessly with loved ones through Clikkle Watsup, accessing premium features such as voice-to-text, swift replies, in-app video, and a host of others secure services on our platform.
          </Typography>
          <Typography
        ...
        <div className="items-center justify-center hidden ml-16 sm:flex ">
          <img
            src="https://cdn.clikkle.com/images/sms/illustration/Group%207.png"
        ...
        <div className="items-center justify-center hidden  ml-16 sm:flex mt-10 ">
          <img
            src="https://cdn.clikkle.com/images/sms/illustration/Group%207.png"
            className="w-full mr-10 h-[calc(100vh-140px)] object-cover object-center"
            alt="Banner"
          />
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center gap-5 sm:mt-7">
        <SmsHomeFeatures/>
        {smsFeatures.map((smsFeatures, index) => (
            <SmsHomeFeature
             {...{ smsFeatures, left: index % 2 === 0, key: smsFeatures.name }}
          />
        ))}
      </div>
          ...
          <div className="flex items-center justify-center gap-4">
            <Button variant="contained" size="small">
              <Link to="https://clikkle.com/tryclikkleplus">
                Try Clikkle Watsup for Free
              </Link>
            </Button>
            <Button variant="outlined" size="small">
              <Link to="https://clikkle.com/gotoplus">Go to Clikkle Watsup</Link>
            </Button>
          </div>
        </div>
