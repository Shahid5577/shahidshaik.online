...
import EsignHomeFeature, {esignFeatures} from "../components/features/esignFeatures";

interface EsignHomeProps {}

const EsignHome: React.FC<EsignHomeProps> = ({}) => {
  useEffect(() => {
    updateTitleAndFavicon("Clikkle Esign | Sign And Send Contracts Faster & Safer", "https://cdn.clikkle.com/images/e-sign/logo/2023/e-sign.png");
  }, []);
  ...
  return (
    <div  className="px-2 py-8 sm:px-6 sm:py-6">
      <div id='home-section' className="p-4 flex flex-col sm:flex-row mt-0 sm:items-center justify-center sm:justify-start h-[calc(68vh-65px)] ml-2">
        <div className="max-w-[600px] px-4 sm:px-8 pb-12 sm:mr-10 gap-6 text-center text-sm">
          <Typography
            variant="h3"
            className="hidden mt-4 font-light text-center text-gray-800 sm:flex sm:text-left dark:text-gray-300 pr-28"
          >
            Power Up Your
            Workflow
            Document
          ...
          >
            Revamp your document workflow with our e-signature
            platform. Streamlined signing for all users,
            comprehensive audit trails, and ironclad security for
            critical documents, Join now.
          </Typography>
          <Typography
        ...
        <div className="items-center justify-center hidden ml-16 sm:flex mr-4 ">
          <img
            src="https://cdn.clikkle.com/images/e-sign/illustration/e-sign1.png"
      ...
      <div className="flex flex-col items-center justify-center gap-5 sm:mt-7">
        {esignFeatures.map((esignFeatures, index) => (
            <EsignHomeFeature
             {...{ esignFeatures, left: index % 2 === 0, key: esignFeatures.name }}
          />
        ))}
      </div>
      ...
      <div id="overview" className="h-[calc(100vh-100px)] flex flex-col items-center justify-center gap-8 mt-10 pt-10">
        <Typography
          ...
          className="text-2xl text-center text-gray-800 sm:text-left dark:text-gray-300"
        >
       Streamlined Secure E-Signature Document Workflows
        </Typography>

        <br />

        <img
          src="https://cdn.clikkle.com/images/e-sign/logo/2023/e-sign.png"
        ...
        audit trails. Collaborate effectively, anywhere, anytime.
          ...
          >
            Learn more about Clikkle E-sign
          </Link>
        </div>
      </div>
          ...
          <div className="flex items-center justify-center gap-4">
            <Button variant="contained" size="small">
              <Link to="https://clikkle.com/tryclikkleplus">
                Try Clikkle E-sign for Free
              </Link>
            </Button>
            <Button variant="outlined" size="small">
              <Link to="https://clikkle.com/gotoplus">Go to Clikkle E-sign</Link>
            </Button>
          </div>
        </div>
