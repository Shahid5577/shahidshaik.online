...
const SocialHome: React.FC<SocialHomeProps> = ({}) => {
  useEffect(() => {
    updateTitleAndFavicon("Clikkle Social | Connect With Freinds And Family Around The World", "https://cdn.clikkle.com/images/social/logo/2023/social.png");
  }, []);
    ...
    <div  className="px-2 py-8 sm:px-6 sm:py-6">
      <div id='home-section' className="p-4 flex flex-col sm:flex-row mt-0 sm:items-center justify-center sm:justify-start h-[calc(68vh-65px)] ml-2 gap-10">
        <div className="max-w-[600px] px-4 sm:px-8 pb-12 sm:mr-10 gap-6 text-center text-sm">
          ...
          >
            Millions of people having fun and making new friends on Clikkle Social every day. You can too!
          </Typography>
          <Typography
            className="font-normal text-center text-gray-800 sm:hidden sm:text-left dark:text-gray-300 sm:mt-0"
        ...
        <div className="items-center justify-center hidden ml-16 sm:flex ">
          <img
            src="https://cdn.clikkle.com/images/social/illustrations/phone%20mockup.png"
        ...
        <div className="items-center justify-center hidden  ml-16 sm:flex ">
          <img
            src="https://cdn.clikkle.com/images/social/illustrations/phone%20mockup.png"
            className="w-full  pl-10 mr-10 h-[calc(100vh-140px)] object-cover object-center mt-16"
            alt="Banner"
          />
        </div>
      </div>
      ...
      <div id="overview" className="h-[calc(100vh-100px)] flex flex-col items-center justify-center gap-8 mt-10 pt-10">
        <Typography
          ...
          className="text-2xl text-center text-gray-800 sm:text-left dark:text-gray-300"
        >
        Have Fun, Connect and Network
        </Typography>

        <br />

        <img
          src="https://cdn.clikkle.com/images/social/logo/2023/social.png"
        ...
        <div className="max-w-[600px] flex flex-col items-center justify-center">
          <Typography className="text-center">
            Get the best social experience from Clikkle, and connect with millions of people from across the globe with our safe and secure platform.
          </Typography>
          ...
          >
            Learn more about Clikkle Social
          </Link>
        </div>
      </div>
          ...
          <div className="flex items-center justify-center gap-4">
            <Button variant="contained" size="small">
              <Link to="https://clikkle.com/tryclikkleplus">
                Try Clikkle Social for Free
              </Link>
            </Button>
            <Button variant="outlined" size="small">
              <Link to="https://clikkle.com/gotoplus">Go to Clikkle Social</Link>
            </Button>
          </div>
        </div>
